...
export function ClientDetailView({ client }: { client: ClientWithAmounts }) {
  ...
  return (
    <div className="relative">
      ...
      {/* Section qui slide - pleine largeur écran */}
      <motion.div
      ...
      >
        <div className="bg-slate-800 dark:bg-slate-900 text-white p-8 shadow-2xl -mx-4 md:-mx-8 lg:-mx-12">
          <div className="container mx-auto">
            ...
            {client.unpaidAmounts.length > 0 ? (
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-600">
                      ...
                      <th className="text-left py-3 px-4">Date échéance</th>
                      <th className="text-right py-3 px-4">Montant</th>
                      <th className="text-center py-3 px-4">Sélection</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <p className="text-center text-slate-300">Aucun montant dû</p>
            )}
