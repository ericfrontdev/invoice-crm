...
>(({ invoice, user, forPrint = false }, ref) => {
    ...
    return (
      <div ref={ref} className={forPrint ? "p-8 bg-white text-black flex flex-col w-full" : "p-4 md:p-12 bg-white text-black flex flex-col w-full"} style={{ maxWidth: '210mm', minHeight: '297mm' }}>
        {/* En-tête */}
            ...
            <div>
              {user.logo ? (
                <img
                  src={user.logo}
                  alt="Logo"
                  className={forPrint ? "h-16 w-auto mb-2" : "h-12 md:h-16 w-auto mb-2 md:mb-4"}
        ...
        {/* Informations client */}
        <div className={forPrint ? "mb-3 bg-gray-50 p-3 rounded" : "mb-6 md:mb-8 bg-gray-50 p-4 md:p-6 rounded"}>
        ...
        <div className={forPrint ? "mb-3 grid grid-cols-2 gap-3" : "mb-6 md:mb-8 grid grid-cols-2 gap-3 md:gap-4"}>
          <div>
        ...
        {/* Tableau des items */}
        <div className={forPrint ? "mb-3 overflow-x-auto" : "mb-6 md:mb-8 overflow-x-auto"}>
        ...
        <div className={forPrint ? "flex justify-end mb-3" : "flex justify-end mb-8 md:mb-12"}>
        ...
        <div className={forPrint ? "border-t pt-2" : "border-t pt-6 md:pt-8"}>
          ...
          <p className={forPrint ? "text-xs md:text-sm text-gray-600 mt-1" : "text-xs md:text-sm text-gray-600 mt-3 md:mt-4"}>
            Merci pour votre confiance !
          </p>
        </div>

        {/* Pied de page */}
        <div className={forPrint ? "mt-auto pt-2 text-center text-xs text-gray-500 border-t" : "mt-auto pt-6 md:pt-8 text-center text-xs text-gray-500 border-t"}>
